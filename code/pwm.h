...
#define MIN_LEFT_MOTOR_SPEED    50 // 50% duty cycle for min speed (can change when calibrated)
#define MAX_LEFT_MOTOR_SPEED    100 // 100% duty cycle for max speed (can change when calibrated)
